...
import { LayoutDashboard, FolderKanban, CheckSquare, LogOut, Command } from 'lucide-react';
    ...
    <aside className="w-64 min-h-screen border-r flex flex-col glass relative z-20" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
      ...
      <div className="px-6 py-5 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-white leading-tight tracking-wide">Team Task</h1>
            <p className="text-[11px] text-slate-400 uppercase tracking-wider font-semibold mt-0.5">Manager</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-5 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
        <div className="flex items-center gap-3 px-2 mb-4">
          ...
          <div className="overflow-hidden">
            ...
            <span className="text-[11px] uppercase tracking-wide font-medium" style={{ color: user?.role === 'admin' ? '#A78BFA' : '#64748B' }}>
              {user?.role || 'member'}
            </span>
          </div>
        </div>
